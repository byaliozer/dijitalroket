  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-radial': 'radial-gradient(ellipse at top, rgba(37,99,235,0.18), transparent 60%), radial-gradient(ellipse at bottom right, rgba(34,211,238,0.12), transparent 55%)',

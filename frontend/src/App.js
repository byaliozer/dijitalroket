...
import DrAiUret from "./pages/DrAiUret";
          ...
          <BrowserRouter>
            ...
            <Routes>
              <Route element={<SiteLayout />}>
                ...
                <Route path="/dr-ai-ile-uret" element={<DrAiUret />} />
...
function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#07111F] text-white px-6 text-center">
      <SEO title="404 - Sayfa Bulunamadı | Dijital Roket" description="Aradığınız sayfa bulunamadı. Dijital Roket ana sayfasına dönerek devam edebilirsiniz." noindex />
